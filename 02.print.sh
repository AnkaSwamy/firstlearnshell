...
echo -e "\[32m Hello world in Green color \e[0m"
echo -e "\[33m Hello world in Yellow color \e[0m"
echo -e "\[34m Hello world in Blue color \e[0m"
echo -e "\[35m Hello world in Magenta color \e[0m"
echo -e "\[36m Hello world in Cyan color \e[0m"
